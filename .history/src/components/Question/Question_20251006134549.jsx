...
function Question2(props) {
	...
	const [isSubmitted, setIsSubmitted] = useState(false) // Add state to track if form has been submitted
	...
	useEffect(() => {
		console.log('Question props:', {
			stage: props.stage,
			answerQuestion: typeof props.answerQuestion,
	...
	const handleSubmit = (e) => {
		...
		if (isSubmitted || input.length === 0) {
			return
		}

		// Check if answerQuestion function exists
		if (typeof props.answerQuestion !== 'function') {
			console.error('answerQuestion prop is not a function:', props.answerQuestion)
			return
		}
	...
	if (!position || typeof props.answerQuestion !== 'function') {
