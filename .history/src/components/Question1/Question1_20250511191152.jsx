...
function Question1(props) {
	...
	const handleClose = (e) => {
		e.stopPropagation()
		console.log('Question1 closing, setting stage to 1')
		setStage(1) // Make sure this is directly setting to 1, not incrementing
		console.log('Stage should now be 1')
	}
