...
import { usePointer } from '@react-three/drei'
...
export default function Home() {
	...
	// useFrame(({ mouse: mousePt }) => {
	// 	// This gives normalized coordinates between -1 and 1
	// 	mouse.current.x = mousePt.x
	// 	mouse.current.y = mousePt.y

	// 	// To convert to world coordinates
	// 	const x = (mousePt.x * viewport.width) / 2
	// 	const y = (mousePt.y * viewport.height) / 2
