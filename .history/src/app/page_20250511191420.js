					...
					>
						{stage === 0 && (
							...
							>
								...
								<p>
									This is a test question replacing Question1
								</p>
								<button
									onClick={() => {
										console.log('Moving from stage 0 to 1')
										setStage(1)
									}}
								>
									Next
						...
						{stage === 1 && (
							...
							>
								...
								<button
									onClick={() => {
										console.log('Moving from stage 1 to 2')
										setStage(2)
									}}
								>
									Next
						...
						{stage === 2 && (
							...
							>
								<h3>Question 3 (Stage 2)</h3>
								<p>Instagram Handle Question</p>
								<input
									type='text'
									value={answer2}
								...
								<button
									onClick={() => {
										console.log('Moving from stage 2 to 3')
										setStage(3)
									}}
								>
									Next
						...
						{/* Add more test questions following the same pattern */}
					</div>
				)}
				<div
					style={{
