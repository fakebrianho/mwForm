...
import { useAudioPreloader } from '@/app/hooks/useAudioPreloader'
import { Canvas } from '@react-three/fiber'
import { Suspense } from 'react'
import { Environment, OrbitControls } from '@react-three/drei'
import Loading from '@/components/Loading/Loading'
import FlashPlane from '@/components/FlashPlane'
...
export default function Home() {
	...
	const { loadingProgress, isLoading: isAudioLoading, error: audioError } = audioPreloader
							...
							<>
								...
								{stage >= 6 && (
									<Question
										...
										stage={'6'}
										question={
											'Shop email or other contact info: '
										}
								...
								{stage >= 7 && (
									<Question
										...
										stage={'7'}
										question={
											'Create a login for database entry: '
										}
