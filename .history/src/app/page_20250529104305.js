...
export default function Home() {
	...
	// Handle timed action after glitchOut is set to true
	useEffect(() => {
		if (glitchOut) {
			const timer = setTimeout(() => {
				// Trigger page transition or other action after 2 seconds
				console.log('Glitch effect completed, triggering transition...')
				// router.push('/next-page') // Uncomment when you have a target page
			}, 2000)
					...
					<>
						...
						{stage >= 2 && (
							<Question
								...
								currentStage={stage}
								stage={'2'}
								question={"Shop's instagram handle: "}
						...
						{stage >= 3 && (
							<Question
								...
								currentStage={stage}
								stage={'3'}
								question={'City the shop is located in: '}
						...
						{stage >= 4 && (
							<Question
								...
								url={'question_4.wav'}
								question={
									'Enter the full address if you know it: '
								}
						...
						{stage >= 6 && (
							<Question
								...
								currentStage={stage}
								stage={'6'}
								question={'Shop email or other contact info: '}
						...
						{stage >= 7 && (
							<Question
								...
								currentStage={stage}
								stage={'7'}
								question={'Create a login for database entry: '}
